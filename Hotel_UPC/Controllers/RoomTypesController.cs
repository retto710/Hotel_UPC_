...
namespace Hotel_UPC.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Description,NumberOfBeds,Price")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Description,NumberOfBeds,Price")] RoomType roomType)
        {
            if (ModelState.IsValid)
            {
